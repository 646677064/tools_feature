...
feature_name=pool5
gpu=4
LOG="/storage2/liushuai/gs6_env/siamese_baiwei329//1.txt"
exec &> >(tee -a "$LOG")
python /storage2/liushuai/gs6_env/market1501_extract_freature/siamse_patch_feature_choose.py \
	/storage2/tiannuodata/work/projdata/baiwei/testdata//patch329/ \
	/storage2/liushuai/gs6_env/siamese_baiwei329/siamese_baiwei329_patch_model/ \
	/storage2/liushuai/gs6_env/siamese_baiwei329/siamese_baiwei329_patch_model/ \
	--gpu $gpu \
