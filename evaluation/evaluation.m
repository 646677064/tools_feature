...
query_feature_name = ['query0.lst.' model_name '.feature.mat'];
test_feature_name  = ['test0.lst.'  model_name '.feature.mat'];

datamat_dir = fullfile(fileparts(mfilename('fullpath')), '..', 'datamat');

fprintf('data mat dir : %s\n', datamat_dir);
test_mat_path  = fullfile(datamat_dir, 'test0.txt');
query_mat_path = fullfile(datamat_dir, 'query0.txt');
