...
patch_dir_root=/storage2/liushuai/gs6_env/baiwei329_patch_result/
dir_out=/storage2/liushuai/gs6_env/shape_baiwei329_result_xml/
LOG="/storage2/liushuai/gs6_env//feature_baiwei329_result_xml.txt"
#exec &> >(tee -a "$LOG")
