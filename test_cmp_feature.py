...
def main(argv):
  ...
  # args.pretrained_model="/storage2/liushuai/gs6_env/caffe-reid/models/market1501/res50_near5/snapshot/res50.full_iter_95000.caffemodel"
  # args.model_def="/storage2/liushuai/gs6_env/caffe-reid/models/market1501/res50_near5/dev.proto"
  args.pretrained_model="/storage2/liushuai/gs6_env/market1501_extract_freature/model/res50.full_iter_110000.caffemodel"
  ...
  # args.feature_name="fc368"
  args.gpu=6
  args.mean_value="110.676,115.771,123.191" #siamese
  args.channel_swap="2,1,0"
  args.channel_swap="0,1,2"
  args.raw_scale =1
  args.images_dim="256,256"
  ...
  path_1="/storage2/liushuai/gs6_env/market1501_extract_freature/test/patch_dir_NG/snow15/162d1d74073w6jz1yznatvf3_0.jpg"
  ...
  path_2="/storage2/liushuai/gs6_env/market1501_extract_freature/test/patch_dir_NG/snow15/162d1d74073w6jz1yznatvf3_0.jpg"
  im_2 = cv2.imread(path_2)
  im_2= im_2*1.0
  #im_2 = skloadimage(path_2)
  _ = classifier.predict([im_2],   args.center_only)#not args.center_only
  feature_2 = classifier.get_blob_data(args.feature_name).copy()
  sio.savemat("/storage2/liushuai/gs6_env/market1501_extract_freature/test/feature_2.feature", {'feature':feature_2})
  ...
  #         ret = comp_feature(save_feature_all[bb_fea],feature.reshape(1, feature.size))
