...
def made_rect_JPEGImages(JPEGImagesDir,AnnotationsDir,outDir_JPEGImages):
    print "==========="
    f_list = os.listdir(JPEGImagesDir)
    i=0
    for file_comp4 in f_list:
...
#              jpegpath)
    ...
    basedir = "/data/tiannuodata/nestle4goods/nestle4goodsproj1/"
    skufile=basedir+"skufile.txt"
    testlistfile = basedir+'/ImageSets_0723/Main/test.txt'
    Annotation_dir = basedir+'/Annotations/'
    resultfile = basedir+'/7_101_result.txt'
    out_dir = basedir+'/analysis/'
    cachedir = out_dir
    cachefilename = "nestle4goodsproj1.pkl"
    ...
    #tianruo_GoodEval(resultfile,Annotation_dir,skufile,testlistfile,cachedir,'nestle4goodsproj1.pkl',threhold=1400)#293
    ...
    # JPEGImagesDir= "/mnt/storage/dataset/baipai/colgate/JPEG/"
    # AnnotationsDir= "/mnt/storage/dataset/baipai/colgate/xml/"
    # outDir_JPEGImages= "/mnt/storage/dataset/baipai/check/"
    # made_rect_JPEGImages(JPEGImagesDir,AnnotationsDir,outDir_JPEGImages)

    basedir = "/data/tiannuodata/nestle4goods/nestle4goodsproj1/"
    skufile="/home/liushuai/tiannuocaffe/1detect_bak/sensodyne4.0.txt"
    testlistfile = basedir+'/ImageSets_0723/Main/test.txt'
    Annotation_dir = basedir+'/Annotations/'
    resultfile = basedir+'/7_101_result.txt'
    out_dir = basedir+'/analysis/'
    cachedir = out_dir
    cachefilename = "nestle4goodsproj1.pkl"
    made_rect_JPEGImages_from_SKUfile(skufile,"/home/liushuai/tiannuocaffe/1detect_bak/true/test.txt","/home/liushuai/tiannuocaffe/1detect_bak/true/","/home/liushuai/tiannuocaffe/1detect_bak/true/","/home/liushuai/tiannuocaffe/1detect_bak/true/true_rect/")
